...
export default function GitHubSection({ value, onChange }: GitHubSectionProps) {
  return (
    <div className="mb-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          type="url"
          required
          className="w-full pl-11 pr-4 py-2.5 rounded-lg text-white placeholder-gray-500 focus:outline-none text-sm"
